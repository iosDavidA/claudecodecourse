...
const ro: Translations = {
  ...
  home: {
    ...
    pageMeta: {
      ...
      '/programare':   { desc: 'Task-uri programate: /loop, task-uri Desktop și Routines în cloud cu /schedule', badge: 'Pro' },
...
const en: Translations = {
  ...
  home: {
    ...
    pageMeta: {
      ...
      '/programare':   { desc: 'Scheduled tasks: /loop, Desktop tasks and cloud Routines with /schedule', badge: 'Pro' },
