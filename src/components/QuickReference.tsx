...
const CONTENT = {
  ro: {
    ...
    flags: [
      ...
      { flag: 'claude --model <id>', desc: 'Selectează modelul: claude-opus-4-8, claude-sonnet-5, claude-haiku-4-5' },
    ...
    builtinCommands: [
      ...
      { cmd: '/fast', desc: 'Comută Fast mode — output mai rapid cu același model (Opus 4.8/4.7)' },
      { cmd: '/model', desc: 'Schimbă modelul activ: opus, sonnet, haiku sau ID complet' },
  ...
  en: {
    ...
    flags: [
      ...
      { flag: 'claude --model <id>', desc: 'Select model: claude-opus-4-8, claude-sonnet-5, claude-haiku-4-5' },
    ...
    builtinCommands: [
      ...
      { cmd: '/fast', desc: 'Toggle Fast mode — faster output with the same model (Opus 4.8/4.7)' },
      { cmd: '/model', desc: 'Switch the active model: opus, sonnet, haiku or full ID' },
