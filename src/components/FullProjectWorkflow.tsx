...
const CONTENT: Record<'ro' | 'en', ContentShape> = {
  ro: {
      ...
      steps: [
        {
          ...
          model: 'Opus 4.8', thinking: 'ultrathink', modelClass: 'text-rose-400 bg-rose-500/10',
    ...
    modele: {
      ...
      matrix: [
        { cat: 'Decizii arhitecturale', model: 'Opus 4.8', thinking: 'ultrathink', cost: '$$$$', why: 'Compun la infinit. Greșeala costă săptămâni.', modelClass: 'text-rose-400' },
        { cat: 'Auth + securitate', model: 'Opus 4.8', thinking: 'think', cost: '$$$', why: 'Vulnerabilitate = catastrofă. Nu economisi.', modelClass: 'text-rose-400' },
        { cat: 'Payments / Stripe', model: 'Opus 4.8', thinking: 'megathink', cost: '$$$', why: 'Bani reali, logică idempotentă critică.', modelClass: 'text-rose-400' },
        { cat: 'Canvas / state complex', model: 'Opus 4.8', thinking: 'megathink', cost: '$$$', why: 'Lifecycle + sync subtil, greu de debugat.', modelClass: 'text-rose-400' },
        { cat: 'Bug neclar, blocat 2+ iterații', model: 'Opus 4.8', thinking: 'ultrathink', cost: '$$$$', why: 'Escaladezi când Sonnet bate pasul pe loc.', modelClass: 'text-rose-400' },
        { cat: 'Migrații DB prod', model: 'Opus 4.8', thinking: 'megathink', cost: '$$$', why: 'Risc pierdere date. Merită gândirea extra.', modelClass: 'text-rose-400' },
        ...
        { cat: 'Refactoring', model: 'Sonnet 5', thinking: 'think', cost: '$$', why: 'Necesită înțelegerea contextului existent.', modelClass: 'text-amber-400' },
        { cat: 'Code review', model: 'Sonnet 5', thinking: 'think', cost: '$$', why: 'Judecată nuanțată, nu regexp scan.', modelClass: 'text-amber-400' },
      ...
      escalation: [
        'Pornești cu Sonnet 5 (default)',
        'Dacă bate pasul pe loc după 2 iterații → Opus + think',
        'Dacă problema e clară dar complexă → Opus + megathink direct',
        'Dacă e decizie strategică sau risc înalt → Opus + ultrathink de la start',
        'Dacă nici Opus nu rezolvă sau e agent long-horizon → Claude Fable 5',
        'Nu escalada invers (Opus → Sonnet) mid-sesiune — pierzi contextul',
      ],
      ...
      costs: [
        ...
        { model: 'Sonnet 5', input: '$3', output: '$15', useCase: 'Features, UI, tests — task-ul zilnic standard' },
        { model: 'Opus 4.8', input: '$5', output: '$25', useCase: 'Arhitectură, security, payments — deciziile importante' },
      ],
      rulesTitle: 'Reguli practice',
      rules: [
        'Un proiect ca ArtisanShop: ~70% Sonnet, ~20% Haiku, ~10% Opus → ~$12-18 total',
  ...
  en: {
    ...
    modele: {
      ...
      matrix: [
        { cat: 'Architectural decisions', model: 'Opus 4.8', thinking: 'ultrathink', cost: '$$$$', why: 'Compound forever. Mistake costs weeks.', modelClass: 'text-rose-400' },
        { cat: 'Auth + security', model: 'Opus 4.8', thinking: 'think', cost: '$$$', why: "Vulnerability = catastrophe. Don't cut costs.", modelClass: 'text-rose-400' },
        { cat: 'Payments / Stripe', model: 'Opus 4.8', thinking: 'megathink', cost: '$$$', why: 'Real money, critical idempotent logic.', modelClass: 'text-rose-400' },
        { cat: 'Canvas / complex state', model: 'Opus 4.8', thinking: 'megathink', cost: '$$$', why: 'Subtle lifecycle + sync, hard to debug.', modelClass: 'text-rose-400' },
        { cat: 'Unclear bug, stuck 2+ iters', model: 'Opus 4.8', thinking: 'ultrathink', cost: '$$$$', why: "Escalate when Sonnet's spinning its wheels.", modelClass: 'text-rose-400' },
        { cat: 'Prod DB migrations', model: 'Opus 4.8', thinking: 'megathink', cost: '$$$', why: 'Risk of data loss. Worth the extra thinking.', modelClass: 'text-rose-400' },
        ...
        { cat: 'Refactoring', model: 'Sonnet 5', thinking: 'think', cost: '$$', why: 'Requires understanding existing context.', modelClass: 'text-amber-400' },
        { cat: 'Code review', model: 'Sonnet 5', thinking: 'think', cost: '$$', why: 'Nuanced judgment, not regexp scan.', modelClass: 'text-amber-400' },
      ...
      escalation: [
        'Start with Sonnet 5 (default)',
        'Stuck after 2 iterations → escalate to Opus + think',
        'Problem is clear but complex → Opus + megathink directly',
        'Strategic decision or high risk → Opus + ultrathink from the start',
        'If even Opus fails or it is a long-horizon agent → Claude Fable 5',
        "Don't escalate in reverse (Opus → Sonnet) mid-session — loses context",
      ],
      ...
      costs: [
        ...
        { model: 'Sonnet 5', input: '$3', output: '$15', useCase: 'Features, UI, tests — daily standard task' },
        { model: 'Opus 4.8', input: '$5', output: '$25', useCase: 'Architecture, security, payments — the big decisions' },
      ],
      rulesTitle: 'Practical rules',
      rules: [
        'A project like ArtisanShop: ~70% Sonnet, ~20% Haiku, ~10% Opus → ~$12-18 total',
